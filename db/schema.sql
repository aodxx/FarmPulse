...
ON weather_snapshots(farm_id, forecast_time DESC);

CREATE INDEX IF NOT EXISTS idx_weather_farm_fetched
...
CREATE INDEX IF NOT EXISTS idx_recommendations_farm_time
ON recommendations(farm_id, evaluated_for DESC);

CREATE INDEX IF NOT EXISTS idx_recommendations_activity
ON recommendations(farm_id, activity_type, evaluated_for DESC);
...
CREATE INDEX IF NOT EXISTS idx_tasks_farm_date
ON farm_tasks(farm_id, task_date DESC);

CREATE INDEX IF NOT EXISTS idx_tasks_status_date
ON farm_tasks(status, task_date);
...
CREATE INDEX IF NOT EXISTS idx_logs_farm_completed
ON farm_logs(farm_id, completed_at DESC);

CREATE INDEX IF NOT EXISTS idx_logs_activity
ON farm_logs(farm_id, activity_type, completed_at DESC);
